...
namespace UCP1_PAW_039_C.Controllers
{
    public class LoginsController : Controller
    {
        ...
        public LoginsController(ClassFunContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdLogin,Username,Password,LoginStatus")] Login login)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdLogin,Username,Password,LoginStatus")] Login login)
        {
            if (id != login.IdLogin)
            {
                return NotFound();
