...
namespace UCP1_PAW_039_C.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public PaymentsController(ClassFunContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPayment,Price,CodePayment")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPayment,Price,CodePayment")] Payment payment)
        {
